...
//    public static final String HOST = "www.webviewgold.com/demo/general_test.php";
    ...
    public static final String HOME_URL = "https://www.example.org";
    ...
    // Set to "true" to open links(_blank, _self) in new tab by default
    ...
    public static final String PURCHASE_LICENSE_KEY = "null";
